    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <a class="navbar-brand" href="#"><img src="<?= base_url('assets/img/ikbal2.png');?>"></a>
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo base_url('siswa/keranjang')?>"><i class="glyphicon glyphicon-shopping-cart"></i> Keranjang Belanja</a></li>
            <li><a href="<?php echo base_url()?>auth/logout"><i class=""></i>  Logout</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
